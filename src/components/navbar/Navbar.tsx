            ...
            <div ref={menuRef} className={`navbar-profile-menu${showMenu ? ' is-open' : ''}`} onMouseEnter={handleMenuMouseEnter} onMouseLeave={handleMenuMouseLeave} onBlur={handleMenuBlur}>
              ...
              {showMenu ? (
                <div className="navbar-dropdown" role="menu" aria-label="Menu do perfil">
                  <Link to="/profile" className="navbar-dropdown-item" role="menuitem" onClick={closeMenu}><span className="navbar-dropdown-icon" aria-hidden="true">P</span><span className="navbar-dropdown-copy"><span className="navbar-dropdown-title">Ver Perfil</span><span className="navbar-dropdown-hint">Editar foto, bio e dados publicos</span></span></Link>
                  {profile?.username ? <Link to={getPublicProfilePath(profile.username)} className="navbar-dropdown-item" role="menuitem" onClick={closeMenu}><span className="navbar-dropdown-icon" aria-hidden="true">U</span><span className="navbar-dropdown-copy"><span className="navbar-dropdown-title">Ver perfil publico</span><span className="navbar-dropdown-hint">Abrir a pagina visivel para outros usuarios</span></span></Link> : null}
